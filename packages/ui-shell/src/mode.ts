...
const MODE_PRESENTATION: Record<AppMode, Omit<ModePresentation, "mode">> = {
  sign_to_english: {
    ...
    supporting: "Point the camera at your signing — Teto turns ASL into clear English.",
  ...
  english_to_sign: {
    ...
    supporting: "Type or speak English — Teto signs it back through a living avatar.",
